...
const translations = {
  uz: {
    ...
    aboutEduDesc: "Men hozirda Yangiariq tumani IT park raqamli texnologiyalar texnikumida o'qib bormoqdaman. Shuningdek, IT park, ya'ni Al-Xorazmiy vorislari loyihasida 2 yil ta'lim olganman va shunga yarasha bilim va ko'nikmalarim ham bor.",
  ...
  ru: {
    ...
    aboutEduDesc: "В настоящее время я учусь в техникуме цифровых технологий IT-парка Янгиарыкского района. Также 2 года обучалась в IT-парке в рамках проекта «Наследники Аль-Хорезми», поэтому у меня есть соответствующие знания и навыки.",
